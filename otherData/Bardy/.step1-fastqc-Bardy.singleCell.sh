...
#$ -N step1-fastqc-Bardy.singleCell
#$ -o ./logs/fastqc-Bardy.$TASK_ID.txt
#$ -e ./logs/fastqc-Bardy.$TASK_ID.txt
#$ -t 1-56
#$ -tc 100
...
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/FastQC/Untrimmed/${ID}

if [ TRUE == "TRUE" ]
then 
    /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/FastQC_v0.11.5/fastqc ${FILE1} ${FILE2} --outdir=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/FastQC/Untrimmed/${ID} --extract
else
    /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/FastQC_v0.11.5/fastqc ${FILE1} --outdir=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/FastQC/Untrimmed/${ID} --extract
fi
