...
#$ -N step8-callVariants-Bardy.singleCell
#$ -o ./logs/callVariants-Bardy.$TASK_ID.txt
#$ -e ./logs/callVariants-Bardy.$TASK_ID.txt
#$ -t 1-56
#$ -tc 100
...
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Genotypes/
...
SNPTMP=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Genotypes/${ID}_tmp.vcf
SNPOUTGZ=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Genotypes/${ID}.vcf.gz
