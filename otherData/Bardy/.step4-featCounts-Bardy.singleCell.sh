...
#$ -N step4-featCounts-Bardy.singleCell
#$ -pe local 8
#$ -o ./logs/featCounts-Bardy.$TASK_ID.txt
#$ -e ./logs/featCounts-Bardy.$TASK_ID.txt
#$ -t 1-56
#$ -tc 30
#$ -hold_jid pipeline_setup,step3-hisat2-Bardy.singleCell
#$ -m a
echo "**** Job starts ****"
date
...
# Directories
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Counts/gene
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Counts/exon
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Counts/junction/tmpdir
...
BAM=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/HISAT2_out/${ID}_accepted_hits.sorted.bam

if [ TRUE == "TRUE" ] ; then 
	# genes	
	/dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/subread-1.5.0-p3-source/bin/featureCounts 	-s 0 -p -T 8 -a /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/GENCODE/GRCh38_hg38/gencode.v25.annotationGRCh38.gtf 	-o /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Counts/gene/${ID}_Gencode.v25.hg38_Genes.counts $BAM
	# exons	
	/dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/subread-1.5.0-p3-source/bin/featureCounts 	-s 0 -p -O -f -T 8 -a /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/GENCODE/GRCh38_hg38/gencode.v25.annotationGRCh38.gtf 	-o /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Counts/exon/${ID}_Gencode.v25.hg38_Exons.counts $BAM
else
	# genes	
...
# junctions	
OUTJXN=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Counts/junction/${ID}_junctions_primaryOnly_regtools.bed
OUTCOUNT=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Counts/junction/${ID}_junctions_primaryOnly_regtools.count
TMPDIR=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Bardy/Counts/junction/tmpdir
