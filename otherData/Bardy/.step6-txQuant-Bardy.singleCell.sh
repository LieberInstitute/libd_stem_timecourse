...
#$ -N step6-txQuant-Bardy.singleCell
#$ -pe local 1
#$ -o ./logs/txQuant-Bardy.$TASK_ID.txt
#$ -e ./logs/txQuant-Bardy.$TASK_ID.txt
#$ -t 1-56
#$ -tc 15
