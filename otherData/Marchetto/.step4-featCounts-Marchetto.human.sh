...
#$ -N step4-featCounts-Marchetto.human
#$ -pe local 8
#$ -o ./logs/featCounts-Marchetto.$TASK_ID.txt
#$ -e ./logs/featCounts-Marchetto.$TASK_ID.txt
#$ -t 1-83
#$ -tc 30
...
# Directories
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Marchetto/Counts/gene
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Marchetto/Counts/exon
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Marchetto/Counts/junction/tmpdir
...
# junctions	
OUTJXN=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Marchetto/Counts/junction/${ID}_junctions_primaryOnly_regtools.bed
OUTCOUNT=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Marchetto/Counts/junction/${ID}_junctions_primaryOnly_regtools.count
TMPDIR=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Marchetto/Counts/junction/tmpdir
