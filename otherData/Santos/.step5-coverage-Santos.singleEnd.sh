...
#$ -N step5-coverage-Santos.singleEnd
#$ -o ./logs/coverage-Santos.$TASK_ID.txt
#$ -e ./logs/coverage-Santos.$TASK_ID.txt
#$ -t 1-24
#$ -tc 40
#$ -hold_jid pipeline_setup,step3-hisat2-Santos.singleEnd,step3b-infer-strandness-Santos.singleEnd
#$ -m a
echo "**** Job starts ****"
date
...
if [ "${STRANDRULE}" == "none" ]
then
    python ~/.local/bin/bam2wig.py -s /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/hg38.chrom.sizes.gencode -i /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Santos/HISAT2_out/${ID}_accepted_hits.sorted.bam -t 4000000000 -o /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Santos/Coverage/${ID}
elif [ "${STRANDRULE}" == "1++,1--,2+-,2-+" ]
then
    python ~/.local/bin/bam2wig.py -s /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/hg38.chrom.sizes.gencode -i /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Santos/HISAT2_out/${ID}_accepted_hits.sorted.bam -t 4000000000 -o /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Santos/Coverage/${ID} -d "1++,1--,2+-,2-+"
elif [ "${STRANDRULE}" == "1+-,1-+,2++,2--" ]
then
    python ~/.local/bin/bam2wig.py -s /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/hg38.chrom.sizes.gencode -i /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Santos/HISAT2_out/${ID}_accepted_hits.sorted.bam -t 4000000000 -o /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Santos/Coverage/${ID} -d "1+-,1-+,2++,2--"
elif [ "${STRANDRULE}" == "++,--" ]
...
## Remove temp files
rm /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/otherData/Santos/Coverage/${ID}*.wig
