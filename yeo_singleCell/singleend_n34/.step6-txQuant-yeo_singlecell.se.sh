...
#$ -N step6-txQuant-yeo_singlecell.se
#$ -pe local 1
#$ -o ./logs/txQuant-yeo_singlecell.$TASK_ID.txt
#$ -e ./logs/txQuant-yeo_singlecell.$TASK_ID.txt
#$ -t 1-34
#$ -tc 15
#$ -hold_jid pipeline_setup,step4-featCounts-yeo_singlecell.se
#$ -m a
echo "**** Job starts ****"
date
