...
#$ -N step1-fastqc-yeo_singlecell.se
#$ -o ./logs/fastqc-yeo_singlecell.$TASK_ID.txt
#$ -e ./logs/fastqc-yeo_singlecell.$TASK_ID.txt
#$ -t 1-34
#$ -tc 100
#$ -hold_jid pipeline_setup,step00-merge-yeo_singlecell.se
#$ -m a
echo "**** Job starts ****"
date
...
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/yeo_singleCell/singleend_n34/FastQC/Untrimmed/${ID}

if [ FALSE == "TRUE" ]
then 
    /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/FastQC_v0.11.5/fastqc ${FILE1} ${FILE2} --outdir=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/yeo_singleCell/singleend_n34/FastQC/Untrimmed/${ID} --extract
else
    /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/FastQC_v0.11.5/fastqc ${FILE1} --outdir=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/yeo_singleCell/singleend_n34/FastQC/Untrimmed/${ID} --extract
fi
