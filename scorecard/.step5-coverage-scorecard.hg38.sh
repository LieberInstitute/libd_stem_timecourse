...
#$ -N step5-coverage-scorecard.hg38
#$ -o ./logs/coverage-scorecard.$TASK_ID.txt
#$ -e ./logs/coverage-scorecard.$TASK_ID.txt
#$ -t 1-73
#$ -tc 40
#$ -hold_jid pipeline_setup,step3-hisat2-scorecard.hg38,step3b-infer-strandness-scorecard.hg38
#$ -m a
echo "**** Job starts ****"
date
...
python ~/.local/bin/bam2wig.py -s /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/hg38.chrom.sizes.gencode -i /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/scorecard/HISAT2_out/${ID}_accepted_hits.sorted.bam -t 4000000000 -o /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/scorecard/Coverage/${ID}  

## Remove temp files
rm /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/scorecard/Coverage/${ID}*.wig
