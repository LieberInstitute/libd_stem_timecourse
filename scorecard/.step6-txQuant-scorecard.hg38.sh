...
#$ -N step6-txQuant-scorecard.hg38
#$ -pe local 1
#$ -o ./logs/txQuant-scorecard.$TASK_ID.txt
#$ -e ./logs/txQuant-scorecard.$TASK_ID.txt
#$ -t 1-73
#$ -tc 15
