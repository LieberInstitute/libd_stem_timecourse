...
#$ -N step4-featCounts-scorecard.hg38
#$ -pe local 8
#$ -o ./logs/featCounts-scorecard.$TASK_ID.txt
#$ -e ./logs/featCounts-scorecard.$TASK_ID.txt
#$ -t 1-73
#$ -tc 30
...
# Directories
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/scorecard/Counts/gene
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/scorecard/Counts/exon
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/scorecard/Counts/junction/tmpdir
...
# junctions	
OUTJXN=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/scorecard/Counts/junction/${ID}_junctions_primaryOnly_regtools.bed
OUTCOUNT=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/scorecard/Counts/junction/${ID}_junctions_primaryOnly_regtools.count
TMPDIR=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/scorecard/Counts/junction/tmpdir
