...
#$ -N step3-hisat2-ziller_hes5.hg38
#$ -pe local 8
#$ -o ./logs/hisat2-ziller_hes5.$TASK_ID.txt
#$ -e ./logs/hisat2-ziller_hes5.$TASK_ID.txt
#$ -t 1-19
#$ -tc 15
#$ -hold_jid pipeline_setup,step2-trim-ziller_hes5.hg38
#$ -m a
echo "**** Job starts ****"
date
...
# Directories
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/align_summaries
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/infer_strandness

if [ FALSE == "TRUE" ]
then
    mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/unaligned
fi
...
if [ -f /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/trimmed_fq/${ID}_trimmed_forward_paired.fastq ] ; then
	## Trimmed, paired-end
	...
	/dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/hisat2-2.0.4/hisat2 -p 8 	-x /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/GENCODE/GRCh38_hg38/hisat2_GRCh38primary -1 $FP -2 $RP -U ${FU},${RU} 	-S /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/${ID}_hisat_out.sam  --phred33      	2>/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/align_summaries/${ID}_summary.txt
	
elif  [ -f /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/trimmed_fq/${ID}_trimmed.fastq ] ; then
	## Trimmed, single-end
	echo "HISAT2 alignment run on trimmed single-end reads"
	/dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Software/hisat2-2.0.4/hisat2 -p 8 	-x /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/GENCODE/GRCh38_hg38/hisat2_GRCh38primary -U /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/trimmed_fq/${ID}_trimmed.fastq 	-S /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/${ID}_hisat_out.sam  --phred33 	2>/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/align_summaries/${ID}_summary.txt
...
###sam to bam
SAM=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/${ID}_hisat_out.sam
ORIGINALBAM=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/${ID}_accepted_hits.bam
SORTEDBAM=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/${ID}_accepted_hits.sorted
...
~/.local/bin/infer_experiment.py -i ${SORTEDBAM}.bam -r /dcl01/lieber/ajaffe/Emily/RNAseq-pipeline/Annotation/RSeQC/hg38.bed 1> /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/HISAT2_out/infer_strandness/${ID}.txt 2>&1
