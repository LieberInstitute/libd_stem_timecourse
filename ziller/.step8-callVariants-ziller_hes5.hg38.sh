...
#$ -N step8-callVariants-ziller_hes5.hg38
#$ -o ./logs/callVariants-ziller_hes5.$TASK_ID.txt
#$ -e ./logs/callVariants-ziller_hes5.$TASK_ID.txt
#$ -t 1-19
#$ -tc 100
...
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/Genotypes/
...
SNPTMP=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/Genotypes/${ID}_tmp.vcf
SNPOUTGZ=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/Genotypes/${ID}.vcf.gz
