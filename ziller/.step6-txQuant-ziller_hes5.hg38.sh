...
#$ -N step6-txQuant-ziller_hes5.hg38
#$ -pe local 1
#$ -o ./logs/txQuant-ziller_hes5.$TASK_ID.txt
#$ -e ./logs/txQuant-ziller_hes5.$TASK_ID.txt
#$ -t 1-19
#$ -tc 15
