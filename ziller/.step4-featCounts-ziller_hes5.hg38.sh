...
#$ -N step4-featCounts-ziller_hes5.hg38
#$ -pe local 8
#$ -o ./logs/featCounts-ziller_hes5.$TASK_ID.txt
#$ -e ./logs/featCounts-ziller_hes5.$TASK_ID.txt
#$ -t 1-19
#$ -tc 30
#$ -hold_jid pipeline_setup,step3-hisat2-ziller_hes5.hg38
#$ -m a
echo "**** Job starts ****"
date
...
# Directories
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/Counts/gene
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/Counts/exon
mkdir -p /dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/Counts/junction/tmpdir
...
# junctions	
OUTJXN=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/Counts/junction/${ID}_junctions_primaryOnly_regtools.bed
OUTCOUNT=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/Counts/junction/${ID}_junctions_primaryOnly_regtools.count
TMPDIR=/dcl01/lieber/ajaffe/lab/libd_stem_timecourse/ziller/Counts/junction/tmpdir
